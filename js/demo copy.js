
{
    ...
    class Slide {
        ...
        setCenter() {
            ...
            TweenMax.to([this.DOM.el, this.DOM.title], 1, {opacity: 1});
        }
        setRight() {
    ...
    class Slideshow {
        ...
        // }
        setVisibleSlides() {
            this.leftSlide = this.slides[this.center];
            this.centerSlide = this.slides[this.center+1 <= this.slidesTotal-1 ? this.center+1 : 0];
            this.rightSlide = this.slides[this.center+2 <= this.slidesTotal-2 ? this.center+2 : 0];
            this.centerSlide.setCenter();
            this.rightSlide.setRight();
            this.leftSlide.setLeft(); 
        }
